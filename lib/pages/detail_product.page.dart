...
class _DetailProductPageState extends State<DetailProductPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(
        () => _productControllerX.loadingDetailProduct.value
            ? SizedBox(
                      ...
                      child: Stack(
                        children: <Widget>[
                          Positioned(
                            child: Hero(
                              tag:
                                  'tag_${purchaseID ?? ''}${productID}_$origin',
                              child: FadeInImage(
                                height: 300,
                                width: MediaQuery.of(context).size.width,
                                fit: BoxFit.cover,
                            ...
                            child: SizedBox(
                              ...
                              child: LikeButton(
                                onPressLike: () async {
                                  ...
                                  int indexHighlight = _productControllerX
                                      .highlightProducts
                                      .indexWhere(
                                    (Product element) =>
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  Container(
                                    decoration: BoxDecoration(
                                      color: Config
                                          .colors[ColorVariables.highlightGray],
                                    ),
